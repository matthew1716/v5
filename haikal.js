...
// Base ʜᴡ ᴍᴏᴅꜱ ᴡᴀ
// Recode Fitur Kenon By Iyuzaki Yanagi (YanaMiku-Project)
// SCRIPT INI DI TULIS DAN DI FIX ULANG OLEH FALLXD 425 DI PERBARUI PADA TANGGAL 25 JUNI 2023,JANGAN DI HAPUS TULISAN INI!! 
// Fitur Emoji Ada Yang Belum Ane list, Nanti Case Emoji Di Tambahin Sndri, Mandiri Ye
...
break
case 'menu': {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/669936db5a7aa65d087ab.jpg' }, caption: `command : ${prefix}
Total Pengguna Premium :  ${owner.length}
Status : ${isCreator ? 'Owner' : 'Free'}
Runtime Bot : ${runtime(process.uptime())}
...
break
case 'bugmenu': {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/4d7960b0fe5fedcc3746b.jpg' }, caption: `command : ${prefix}
Total Pengguna Premium :  ${owner.length}
Status : ${isCreator ? 'Owner' : 'Free'}
Runtime Bot : ${runtime(process.uptime())}
...
Sewa Bot ? Hubungi Admin Untuk Nego Wa.me/6285813708397`)
}
break
